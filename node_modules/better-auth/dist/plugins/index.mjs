export { o as organization, p as parseRoles } from '../shared/better-auth.BuVTCgK_.mjs';
...
export { H as HIDE_METADATA } from '../shared/better-auth.Dm9JBENp.mjs';
...
export { a as admin } from '../shared/better-auth.6v1lyy-4.mjs';
...
import { o as oidcProvider, s as schema } from '../shared/better-auth.K3oiIXoq.mjs';
export { g as getClient, a as getMetadata } from '../shared/better-auth.K3oiIXoq.mjs';
export { captcha } from './captcha/index.mjs';
export { A as API_KEY_TABLE_NAME, E as ERROR_CODES, a as apiKey, d as defaultKeyHasher, o as oneTimeToken } from '../shared/better-auth.DK2lPFsm.mjs';
export { haveIBeenPwned } from './haveibeenpwned/index.mjs';
import * as z from 'zod';
import { APIError } from 'better-call';
import { b as isProduction } from '../shared/better-auth.CiuwFiHM.mjs';
...
import '../shared/better-auth.CVTnFdZK.mjs';
...
import '../shared/better-auth.ZBjauyTk.mjs';
            ...
            user: {
              create: {
                async before(user, context) {
                  ...
                  if (!context) return;
                  const lastUsedLoginMethod = config.customResolveMethod(context);
...
export { createAuthEndpoint, createAuthMiddleware, getMCPProtectedResourceMetadata, getMCPProviderMetadata, lastLoginMethod, mcp, oAuthDiscoveryMetadata, oAuthProtectedResourceMetadata, oidcProvider, withMcpAuth };
