...
import { p as parseState, v as validateAuthorizationCode, b as validateToken, j as handleOAuthUserInfo, s as setTokenUtil, g as generateState, c as createAuthorizationURL } from '../../shared/better-auth.Dm9JBENp.mjs';
    ...
    endpoints: {
      ...
      callbackSSO: createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          const discovery = await betterFetch(provider.oidcConfig.discoveryEndpoint);
          if (discovery.data) {
            config = {
