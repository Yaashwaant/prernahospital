...
import { U as User, S as Session, i as AuthContext, L as FieldAttribute, ak as InferAdditionalFieldsFromPluginOptions, G as GenericEndpointContext } from '../../shared/better-auth.B2TW1bPT.mjs';
            ...
            <AsResponse extends boolean = false, ReturnHeaders extends boolean = false>(inputCtx_0: {
                body: {
                    ...
                    data: {
                        permission?: Record<string, string[]>;
                        roleName?: string;
                    } & Partial<Partial<InferAdditionalFieldsFromPluginOptions<"organizationRole", O, true>>>;
                } & ({
                    roleName: string;
                } | {
                    roleId: string;
