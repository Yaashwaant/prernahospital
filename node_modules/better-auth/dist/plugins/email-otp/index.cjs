...
const emailOTP = (options) => {
  ...
  const endpoints = {
     ...
     */
    sendVerificationOTP: session.createAuthEndpoint(
  ...
  return {
    ...
    endpoints: {
      ...endpoints,
      createVerificationOTP: session.createAuthEndpoint(
       ...
       */
      getVerificationOTP: session.createAuthEndpoint(
       ...
       */
      checkVerificationOTP: session.createAuthEndpoint(
       ...
       */
      verifyEmailOTP: session.createAuthEndpoint(
       ...
       */
      signInEmailOTP: session.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: z__namespace.object({
       ...
       */
      forgetPasswordEmailOTP: session.createAuthEndpoint(
       ...
       */
      resetPasswordEmailOTP: session.createAuthEndpoint(
