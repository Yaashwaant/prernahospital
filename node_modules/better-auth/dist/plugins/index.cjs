...
const organization = require('../shared/better-auth.C76lPSDY.cjs');
...
const admin = require('../shared/better-auth.CTsKSwa1.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.CiB_ZMrx.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.BBxSzNpN.cjs');
...
require('../shared/better-auth.BSvTlywO.cjs');
...
require('../shared/better-auth.yamXE7-N.cjs');
...
const mcp = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      getMCPProtectedResource: session.createAuthEndpoint(
