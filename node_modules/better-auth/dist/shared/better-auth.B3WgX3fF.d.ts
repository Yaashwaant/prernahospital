...
import { b as LiteralUnion, L as LiteralString, D as DeepPartial, U as UnionToIntersection, a as Prettify, S as StripEmptyObjects, O as OmitId, P as PrettifyDeep, E as Expand } from './better-auth.DTtXpZYr.js';
import { b as OAuthProvider, S as SocialProviders, c as SocialProviderList, O as OAuth2Tokens, a as OAuth2UserInfo } from './better-auth.B2AIpsP8.js';
...
type Adapter = {
     ...
     */
    transaction: <R>(callback: (tx: Omit<Adapter, "transaction">) => Promise<R>) => Promise<R>;
    /**
     *
     * @param options
...
declare const createInternalAdapter: (adapter: Adapter, ctx: {
    ...
    createOAuthUser: (user: Omit<User, "id" | "createdAt" | "updatedAt">, account: Omit<Account, "userId" | "id" | "createdAt" | "updatedAt"> & Partial<Account>, context?: GenericEndpointContext) => Promise<{
        user: any;
        account: any;
    }>;
    createUser: <T>(user: Omit<User, "id" | "createdAt" | "updatedAt" | "emailVerified"> & Partial<User> & Record<string, any>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<T & {
        id: string;
        createdAt: Date;
        updatedAt: Date;
        email: string;
    ...
    createAccount: <T extends Record<string, any>>(account: Omit<Account, "id" | "createdAt" | "updatedAt"> & Partial<Account> & T, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<T & {
        id: string;
        createdAt: Date;
        updatedAt: Date;
        providerId: string;
    ...
    listSessions: (userId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
    ...
    listUsers: (limit?: number, offset?: number, sortBy?: {
        field: string;
        direction: "asc" | "desc";
    }, where?: Where[], trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        email: string;
    ...
    countTotalUsers: (where?: Where[], trxAdapter?: TransactionAdapter) => Promise<number>;
    deleteUser: (userId: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    createSession: (userId: string, ctx: GenericEndpointContext, dontRememberMe?: boolean, override?: Partial<Session> & Record<string, any>, overrideAll?: boolean, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
    ...
    findSession: (token: string, trxAdapter?: TransactionAdapter) => Promise<{
        session: Session & Record<string, any>;
        user: User & Record<string, any>;
    } | null>;
    findSessions: (sessionTokens: string[], trxAdapter?: TransactionAdapter) => Promise<{
        session: Session;
        user: User;
    }[]>;
    updateSession: (sessionToken: string, session: Partial<Session> & Record<string, any>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
    deleteSession: (token: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    deleteAccounts: (userId: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    deleteAccount: (accountId: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    deleteSessions: (userIdOrSessionTokens: string | string[], trxAdapter?: TransactionAdapter) => Promise<void>;
    findOAuthUser: (email: string, accountId: string, providerId: string, trxAdapter?: TransactionAdapter) => Promise<{
        user: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    }, trxAdapter?: TransactionAdapter) => Promise<{
        user: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    findUserById: (userId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        email: string;
    ...
    linkAccount: (account: Omit<Account, "id" | "createdAt" | "updatedAt"> & Partial<Account>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
    updateUser: (userId: string, data: Partial<User> & Record<string, any>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
    updateUserByEmail: (email: string, data: Partial<User & Record<string, any>>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
    updatePassword: (userId: string, password: string, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<void>;
    findAccounts: (userId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        providerId: string;
    ...
    findAccount: (accountId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        providerId: string;
    ...
    findAccountByProviderId: (accountId: string, providerId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        providerId: string;
    ...
    findAccountByUserId: (userId: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        providerId: string;
    ...
    updateAccount: (id: string, data: Partial<Account>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
    createVerificationValue: (data: Omit<Verification, "createdAt" | "id" | "updatedAt"> & Partial<Verification>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        value: string;
    ...
    findVerificationValue: (identifier: string, trxAdapter?: TransactionAdapter) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        value: string;
    ...
    deleteVerificationValue: (id: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    deleteVerificationByIdentifier: (identifier: string, trxAdapter?: TransactionAdapter) => Promise<void>;
    updateVerificationValue: (id: string, data: Partial<Verification>, context?: GenericEndpointContext, trxAdapter?: TransactionAdapter) => Promise<any>;
};
...
declare const signInSocial: {
    ...
    options: {
        ...
        body: z.ZodObject<{
            ...
            provider: z.ZodType<"apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown, z.core.$ZodTypeInternals<"apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown>>;
        ...
        signInSocial: {
            ...
            options: {
                ...
                body: z.ZodObject<{
                    ...
                    newUserCallbackURL: z.ZodOptional<z.ZodString>;
                    errorCallbackURL: z.ZodOptional<z.ZodString>;
                    provider: z.ZodType<"apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown, zod_v4_core.$ZodTypeInternals<"apple" | "atlassian" | "cognito" | "discord" | "facebook" | "figma" | "github" | "microsoft" | "google" | "huggingface" | "slack" | "spotify" | "twitch" | "twitter" | "dropbox" | "kick" | "linear" | "linkedin" | "gitlab" | "tiktok" | "reddit" | "roblox" | "salesforce" | "vk" | "zoom" | "notion" | "kakao" | "naver" | "line" | "paypal" | (string & {}), unknown>>;
                    disableRedirect: z.ZodOptional<z.ZodBoolean>;
                    idToken: z.ZodOptional<z.ZodObject<{
                        token: z.ZodString;
                        nonce: z.ZodOptional<z.ZodString>;
...
export { betterAuth as N, init as Q, freshSessionMiddleware as a$, levels as a3, shouldPublishLog as a4, createLogger as a8, logger as a9, parseAdditionalUserInput as aA, parseAccountInput as aB, parseSessionInput as aC, mergeSchema as aD, createCookieGetter as aE, getCookies as aF, setCookieCache as aH, setSessionCookie as aI, deleteSessionCookie as aJ, parseCookies as aK, getSessionCookie as aM, getCookieCache as aN, parseSetCookieHeader as aO, checkEndpointConflicts as aP, getEndpoints as aQ, router as aR, signInSocial as aS, signInEmail as aT, callbackOAuth as aU, getSessionQuerySchema as aV, getSession as aW, getSessionFromCtx as aX, sessionMiddleware as aY, sensitiveSessionMiddleware as aZ, requestOnlySessionMiddleware as a_, createInternalAdapter as ab, createFieldAttribute as ae, getAuthTables as an, coreSchema as ao, accountSchema as ap, userSchema as aq, sessionSchema as ar, verificationSchema as as, parseOutputData as at, getAllFields as au, parseUserOutput as av, parseAccountOutput as aw, parseSessionOutput as ax, parseInputData as ay, parseUserInput as az, listSessions as b0, revokeSession as b1, revokeSessions as b2, revokeOtherSessions as b3, signOut as b4, requestPasswordReset as b5, forgetPassword as b6, requestPasswordResetCallback as b7, forgetPasswordCallback as b8, resetPassword as b9, createEmailVerificationToken as ba, sendVerificationEmailFn as bb, sendVerificationEmail as bc, verifyEmail as bd, updateUser as be, changePassword as bf, setPassword as bg, deleteUser as bh, deleteUserCallback as bi, changeEmail as bj, error as bk, ok as bl, signUpEmail as bm, listUserAccounts as bn, linkSocialAccount as bo, unlinkAccount as bp, getAccessToken as bq, refreshToken as br, accountInfo as bs, originCheckMiddleware as bt, originCheck as bu, BASE_ERROR_CODES as g, checkPassword as l, setCookieToHeader as v, optionsMiddleware as x, createAuthMiddleware as y, createAuthEndpoint as z };
export type { SecondaryStorage as $, AdapterDebugLogs as A, BetterAuthOptions as B, CreateAdapterOptions as C, AuthEndpoint as D, AuthMiddleware as E, FilterActions as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, TelemetryEvent as J, KyselyDatabaseType as K, FieldAttribute as L, Models as M, AdditionalSessionFieldsInput as O, Account as P, RateLimit as R, Session as S, TelemetryContext as T, User as U, Verification as V, WithJsDoc as W, Where as X, TransactionAdapter as Y, AdapterSchemaCreation as Z, AdapterInstance as _, Adapter as a, FilteredAPI as a0, InferSessionAPI as a1, LogLevel as a2, Logger as a5, LogHandlerParams as a6, InternalLogger as a7, BetterAuthCookies as aG, EligibleCookies as aL, FieldType as aa, InternalAdapter as ac, FieldAttributeConfig as ad, InferValueType as af, InferFieldsOutput as ag, InferFieldsInput as ah, InferFieldsInputClient as ai, FieldAttributeToObject as aj, InferAdditionalFieldsFromPluginOptions as ak, PluginFieldAttribute as al, BetterAuthDbSchema as am, AdapterConfig as b, CreateCustomAdapter as c, CustomAdapter as d, CleanedWhere as e, AdapterTestDebugLogs as f, Auth as h, AuthContext as i, InferUser as j, InferSession as k, InferAPI as m, AdditionalSessionFieldsOutput as n, AdditionalUserFieldsOutput as o, InferFieldsFromPlugins as p, InferFieldsFromOptions as q, AdditionalUserFieldsInput as r, BetterAuthPlugin as s, InferPluginTypes as t, InferPluginErrorCodes as u, AuthPluginSchema as w };
