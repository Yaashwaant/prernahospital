import { a as Adapter, B as BetterAuthOptions, G as GenericEndpointContext, Y as TransactionAdapter, X as Where, L as FieldAttribute, aa as FieldType, K as KyselyDatabaseType } from '../shared/better-auth.Cxv0YRbF.cjs';
export { am as BetterAuthDbSchema, ad as FieldAttributeConfig, aj as FieldAttributeToObject, ak as InferAdditionalFieldsFromPluginOptions, q as InferFieldsFromOptions, p as InferFieldsFromPlugins, ah as InferFieldsInput, ai as InferFieldsInputClient, ag as InferFieldsOutput, af as InferValueType, ac as InternalAdapter, al as PluginFieldAttribute, ap as accountSchema, ao as coreSchema, ae as createFieldAttribute, ab as createInternalAdapter, au as getAllFields, an as getAuthTables, aD as mergeSchema, aB as parseAccountInput, aw as parseAccountOutput, aA as parseAdditionalUserInput, ay as parseInputData, at as parseOutputData, aC as parseSessionInput, ax as parseSessionOutput, az as parseUserInput, av as parseUserOutput, ar as sessionSchema, aq as userSchema, as as verificationSchema } from '../shared/better-auth.Cxv0YRbF.cjs';
