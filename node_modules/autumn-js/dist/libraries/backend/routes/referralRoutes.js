...
var referralRoutes_exports = {};
__export(referralRoutes_exports, {
  addReferralRoutes: () => addReferralRoutes
});
module.exports = __toCommonJS(referralRoutes_exports);
...
var addReferralRoutes = async (router, options) => {
  (0, import_rou3.addRoute)(router, "POST", `${BASE_PATH}/referrals/code`, {
    handler: createReferralCodeHandler(options)
  });
  (0, import_rou3.addRoute)(router, "POST", `${BASE_PATH}/referrals/redeem`, {
