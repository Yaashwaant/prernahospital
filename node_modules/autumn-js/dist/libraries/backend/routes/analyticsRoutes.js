...
__export(analyticsRoutes_exports, {
  addAnalyticsRoutes: () => addAnalyticsRoutes
});
...
var addAnalyticsRoutes = (router, options) => {
  (0, import_rou3.addRoute)(router, "POST", `${BASE_PATH}/events/list`, {
    handler: listEventsHandler(options)
  });
  (0, import_rou3.addRoute)(router, "POST", `${BASE_PATH}/events/aggregate`, {
