...
var remix_dep_exports = {};
__export(remix_dep_exports, {
  autumnHandler: () => autumnHandler
});
module.exports = __toCommonJS(remix_dep_exports);
...
function autumnHandler(options) {
  ...
  async function handleAutumnRequest(args) {
    ...
    const match = (0, import_rou37.findRoute)(router, args.request.method, pathname);
    if (!match) {
