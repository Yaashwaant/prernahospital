...
__export(clientGenTypes_exports, {
  CancelParamsSchema: () => CancelParamsSchema2,
  CheckParamsSchema: () => CheckParamsSchema2,
  OpenBillingPortalParamsSchema: () => OpenBillingPortalParamsSchema,
  QueryParamsSchema: () => QueryParamsSchema2,
  SetupPaymentParamsSchema: () => SetupPaymentParamsSchema,
  TrackParamsSchema: () => TrackParamsSchema2
});
...
var CancelParamsSchema2 = import_v412.z.object({
  productId: import_v412.z.string(),
  entityId: import_v412.z.string().optional(),
  cancelImmediately: import_v412.z.boolean().optional()
});
var CheckParamsSchema2 = import_v412.z.object({
  featureId: import_v412.z.string().optional(),
  productId: import_v412.z.string().optional(),
  entityId: import_v412.z.string().optional(),
  requiredBalance: import_v412.z.number().optional(),
  sendEvent: import_v412.z.boolean().optional(),
  withPreview: import_v412.z.boolean().optional(),
  dialog: import_v412.z.any().optional(),
  entityData: import_v412.z.any().optional(),
  properties: import_v412.z.record(import_v412.z.string(), import_v412.z.any()).optional()
});
var TrackParamsSchema2 = import_v412.z.object({
  featureId: import_v412.z.string().optional(),
  eventName: import_v412.z.string().optional(),
  entityId: import_v412.z.string().optional(),
  value: import_v412.z.number().optional(),
  idempotencyKey: import_v412.z.string().optional(),
  entityData: import_v412.z.any().optional()
});
var OpenBillingPortalParamsSchema = import_v412.z.object({
  returnUrl: import_v412.z.string().optional(),
  openInNewTab: import_v412.z.boolean().optional()
});
var SetupPaymentParamsSchema = import_v412.z.object({
...
var QueryParamsSchema2 = import_v412.z.object({
  featureId: import_v412.z.string().or(import_v412.z.array(import_v412.z.string())),
  range: QueryRangeEnum.optional()
});
