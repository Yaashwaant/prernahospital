...
var paywall_dialog_synced_exports = {};
__export(paywall_dialog_synced_exports, {
  default: () => PaywallDialog
});
module.exports = __toCommonJS(paywall_dialog_synced_exports);
...
var Accordion = import_react11.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
...
var AccordionImplMultiple = import_react11.default.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
    AccordionValueProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
    }
  );
});
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Collection.Slot, { scope: __scopeAccordion, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          Primitive.div,
          {
            ...accordionProps,
...
var AccordionTrigger = import_react11.default.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Collection.ItemSlot, { scope: __scopeAccordion, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      Trigger2,
      {
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Root23, { ...popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    PopoverProvider,
    {
...
var PricingCardButton = import_react14.default.forwardRef(({ recommended, children, className, onClick, ...props }, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    Button,
    {
      ...
      onClick: handleClick,
      children: loading ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(LoaderCircle, { className: "au-h-4 au-w-4 au-animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "au-flex au-items-center au-justify-between au-w-full au-transition-transform au-duration-300 group-hover:au-translate-y-[-130%]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { children }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "au-text-sm", children: "\u2192" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "au-flex au-items-center au-justify-between au-w-full au-absolute au-px-4 au-translate-y-[130%] au-transition-transform au-duration-300 group-hover:au-translate-y-0 au-mt-2 group-hover:au-mt-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { children }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "au-text-sm", children: "\u2192" })
        ] })
      ] })
...
function PaywallDialog(params) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(Dialog2, { open, onOpenChange: setOpen, children: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(DialogContent2, { className: "au-p-0 au-pt-4 au-gap-0 au-text-foreground au-overflow-hidden au-text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(DialogTitle2, { className: cn("au-font-bold au-text-xl au-px-6"), children: title }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { className: "au-px-6 au-my-2", children: message }),
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(DialogFooter, { className: "au-flex au-flex-col sm:au-flex-row au-justify-between au-gap-x-4 au-py-2 au-mt-4 au-pl-6 au-pr-3 au-bg-secondary au-border-t", children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
      Button,
      {
        size: "sm",
