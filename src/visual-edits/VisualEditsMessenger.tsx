import skills from './skills'; // from skills.js or skills.ts/* eslint-disable @typescript-eslint/no-explicit-any */
"use client";
  ...
  useEffect(() => {
    ...
    function onClickCapture(e: MouseEvent) {
      ...
      if (hit) {
        ...
        if (hitId && typeof window !== "undefined" && typeof localStorage !== "undefined") {
    ...
    function onMsg(e: MessageEvent<ParentToChild>) {
      ...
      if (e.data.msg === "VISUAL_EDIT_MODE" && "active" in e.data) {
        ...
        if (!newMode && typeof window !== "undefined" && typeof localStorage !== "undefined") {
